...
> Be patient! In ~3 mins your app is live, at your [app url](http://newton-z1hni2a.newton.wiki/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: http://newton-z1hni2a.newton.wiki/
...
```
git clone git@github.com:Blackadams/newton-z1hni2a.git
```
